...
import { resetAiRateLimiter } from '@/utils/aiInsights';
...
describe('aiInsights', () => {
  ...
  describe('generateInsight', () => {
    it('returns insight from API response', async () => {
      ...
      const { generateInsight } = await import('@/utils/aiInsights');
  ...
  describe('generateWeeklyReport', () => {
    it('returns report from API response', async () => {
      ...
      const { generateWeeklyReport } = await import('@/utils/aiInsights');
  ...
  describe('canMakeAiRequest', () => {
    it('blocks rapid successive calls', async () => {
      const { canMakeAiRequest } = await import('@/utils/aiInsights');
